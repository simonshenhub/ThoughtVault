...
struct SupabaseClient {
    private let baseURL = "https://xbouikkzywbknxwkdaxx.supabase.co/rest/v1"
    private let apiKey = "sb_publishable_h9NO_aoJ5pYAFMRJ_pK_cQ_dwvxwV2t"
    private let schema = "thoughtvault"
